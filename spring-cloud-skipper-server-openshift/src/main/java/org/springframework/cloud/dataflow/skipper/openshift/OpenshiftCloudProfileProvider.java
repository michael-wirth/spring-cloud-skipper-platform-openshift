 ...
 */
public class OpenshiftCloudProfileProvider implements CloudProfileProvider {

	public final static String PROFILE = "openshift";

	@Override
	public boolean isCloudPlatform(Environment environment) {
		return environment.containsProperty("kubernetes_namespace");
	}
